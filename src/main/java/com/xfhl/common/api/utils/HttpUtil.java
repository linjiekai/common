...
public class HttpUtil {
    ...
    public static CloseableHttpClient createSSLClientDefault(boolean isHttps) {
        try {
            ...
            throw new CommonException("9001", "创建HttpClient失败", e);
        }
    ...
    public static String httpsRequest(Map<String, Object> headerMap, String requestUrl, String requestMethod, String outputStr) throws Exception {
        ...
        try {
            ...
            log.error("连接超时", e);
            throw new CommonException("13108", ApplicationYmlUtil.get(13108), e);
        } catch (ConnectException e) {
            log.error("连接失败", e);
            throw new CommonException("13108", ApplicationYmlUtil.get(13108), e);
        } catch (Exception e) {
            log.error("请求接口异常", e);
            throw new CommonException("13109", ApplicationYmlUtil.get(13109), e);
        } finally {
            try {
